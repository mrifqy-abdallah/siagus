...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Master
        {
            ...
            public static class KelasParalel
            {
                public const string KelasParalelIndex = "~/Modules/Master/KelasParalel/KelasParalelIndex.cshtml";
            }

            public static class Mapel
            {
                public const string MapelIndex = "~/Modules/Master/Mapel/MapelIndex.cshtml";
            }

            public static class MapelGuru
            {
                public const string MapelGuruIndex = "~/Modules/Master/MapelGuru/MapelGuruIndex.cshtml";
            }
            ...
            public static class Tatausaha
            {
                public const string TatausahaIndex = "~/Modules/Master/Tatausaha/TatausahaIndex.cshtml";
            }

            public static class Wali
            {
                public const string WaliIndex = "~/Modules/Master/Wali/WaliIndex.cshtml";
            }
